package org.microsauce.gravy.template.gstring
...
class GStringTemplateEngine {
    ...
    public GStringTemplateEngine(config) {
        configure(config)

        templateEngine = new org.microsauce.gravy.template.GStringTemplateEngine()
