...
abstract class ServiceFactory {
	...
	@Override
	@CompileStatic
	public EnterpriseService makeEnterpriseService(Object scriptContext, String uriPattern, Map<String, Object> methodHandlers, List<DispatcherType> dispatch, Module module ) { 
